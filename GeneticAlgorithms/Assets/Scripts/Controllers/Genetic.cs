...
namespace AISandbox
{
    public class Genetic : MonoBehaviour
    {
        ...
        {
            if (m_command_index + 1 >= Chromosome.m_CHROMOSOME_LENGTH)
            {
                m_command_index = 0;
            }

            // Pass all parameters to the character control script.
            m_actor.Steering = new Vector2(0, Chromosome.Genes[m_command_index]);
            m_actor.AltSteering = new Vector2(0, Chromosome.Genes[m_command_index + 1]);
        }
